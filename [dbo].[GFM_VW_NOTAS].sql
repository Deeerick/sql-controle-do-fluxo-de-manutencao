...
SELECT
    ...
    CASE WHEN CHARINDEX('MSPN', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 THEN 1 ELSE 0 END AS MSPN,
    CASE WHEN CHARINDEX('MSDI', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 THEN 1 ELSE 0 END AS MSDI,
    CASE
        WHEN CHARINDEX('MSPR', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 AND
        CHARINDEX('TRIA', STATUS_SISTEMA + ' ' + STATUS_USUARIO) = 0 AND
        CHARINDEX('SUSP', STATUS_SISTEMA + ' ' + STATUS_USUARIO) = 0 AND
        ORDEM IS NULL THEN 1
        ELSE 0
    END AS AGTR,
    CASE
        WHEN CHARINDEX('MSPR', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 AND
    ...
    END AS INC3,
    CASE
        WHEN CHARINDEX('MSEN', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 AND
        CHARINDEX('MREL', STATUS_SISTEMA + ' ' + STATUS_USUARIO) = 0 AND
        CHARINDEX('EXCL', STATUS_SISTEMA + ' ' + STATUS_USUARIO) = 0 AND
        ORDEM IS NOT NULL THEN 1
        ELSE 0
    END AS NECO,
    CASE
    ...
    END AS NESO,
    CASE
        WHEN CHARINDEX('MREL', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 OR CHARINDEX('EXCL', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 THEN 1
        ELSE 0
    END AS NOCA,
    CASE
