...
SELECT
    ...
    CASE WHEN CHARINDEX('SUSP', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 THEN 1 ELSE 0 END AS SUSP,
    CASE WHEN CHARINDEX('TRIA', STATUS_SISTEMA + ' ' + STATUS_USUARIO) > 0 THEN 1 ELSE 0 END AS TRIA,
