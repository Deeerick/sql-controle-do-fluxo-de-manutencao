...
FROM
	BIIN.BIIN.VW_NOTA_MANUTENCAO AS nota
LEFT JOIN BIIN.BIIN.VW_NOTA_MANUTENCAO_MEDIDA AS medida ON
	nota.NOTA = medida.NUMERO_NOTA
LEFT JOIN BIIN.BIIN.VW_BIIN_TEXTO_LONGO_NOTA_MANUTENCAO_MEDIDA AS txt_longo ON
...
LEFT JOIN (
	...
	FROM
		BIIN.BIIN.VW_BIIN_HISTORICO_STATUS_MEDIDA
	WHERE
