...
SELECT
    ...
    CASE
        WHEN CHARINDEX('INIT', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0 THEN 1
        ELSE 0
    END AS INIT,
    CASE
    ...
    CASE
        WHEN CHARINDEX('MSUC', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0
        OR CHARINDEX('ELIM', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0 THEN 1
        ELSE 0
    END AS MED_CANCELADA
FROM
